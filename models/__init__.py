...
from .OldModel import ShowAttendTellModel, AllImgModel, BreakingNews
from .OldModelPointer import ShowAttendTellModelPointer
...
def setup(opt):
    ...
    elif 'show_attend_tell' in opt.caption_model or 'ICECAP' in opt.caption_model:
    ...
    elif 'BNmodel' in opt.caption_model:
        model = BreakingNews(opt)
    else:
